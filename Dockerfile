...
FROM netboxcommunity/netbox:v4.3.7@sha256:4545abd95eb92aea0d8895658fc37b958d9647bc064c4c88475741ae5daada4f
...
RUN apt-get -q update; apt-get -qy upgrade && \
  ...
  echo 'PLUGINS = ["netbox_qrcode","netbox_interface_synchronization","netbox_topology_views","netbox_inventory","netbox_floorplan","netbox_documents","netbox_lifecycle","netbox_otp_plugin"]' >> /etc/netbox/config/plugins.py && \
